...
/**
 * The persistent class for the TWS1002_ANAGISTSCOL database table.
 * 
 */
@Entity
@Table(name="TWS1002_ANAGISTSCOL", schema = "", catalog = "")
@NamedQuery(name="Tws1002Anagistscol.findAll", query="SELECT m FROM Tws1002Anagistscol m")
public class Tws1002Anagistscol implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private Tws1002AnagistscolPK id;
	...
	private Twb1014Comune twb1014Comune;
	...
	public Tws1002Anagistscol() {
	}

	public Tws1002AnagistscolPK getId() {
		return this.id;
	}

	public void setId(Tws1002AnagistscolPK id) {
		this.id = id;
	}
	...
	public Twb1014Comune getTwb1014Comune() {
		return twb1014Comune;
	}

	public void setTwb1014Comune(Twb1014Comune twb1014Comune) {
		this.twb1014Comune = twb1014Comune;
	}
