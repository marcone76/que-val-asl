...
@Embeddable
public class Vod1001ModTabRisPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Vod1001ModTabRisPK)) {
			return false;
		}
		Vod1001ModTabRisPK castOther = (Vod1001ModTabRisPK)other;
		return 
