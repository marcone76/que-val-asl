 ...
 */
@Entity
@Table(name="TWB1014_COMUNE", schema = "", catalog = "")
@NamedQuery(name="Twb1014Comune.findAll", query="SELECT m FROM Twb1014Comune m")
public class Twb1014Comune implements Serializable {
