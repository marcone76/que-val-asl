						...
						<div class="panel panel-default">
							<div class="panel-heading">
							      <h3 class="panel-title">
							        <a href="#schedeVis?breadcrumbTitle=Scheda&subItem=y&scheda=${sezione.idSezione}&codQuest=${questionario.codiceQuestionario}&codForteScu=${scuola.codiceForte}&sezioneValidata=${sezioneValidata}&codEdi=">${sezione.descrizioneSezione}</a>
							        <c:if test="${sezioneValidata ne '1'}">
